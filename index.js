const { printFakerHelp } = require('.src/tools/graph_faker/help');
const { printMockerHelp, printCompleteSchemaHelp, printExtractApiHelp } = require('.src/tools/graph_mocker/help');

const { printSaverHelp } = require('.src/tools/graph_saver/help');
const extract_api = require('.src/tools/graph_mocker/extract_api_schema').main;
const complete_schema = require('.src/tools/graph_mocker/complete_schema').main;
const fak = require('.src/tools/graph_faker/gr_faker').main;
const mock = require('.src/tools/graph_mocker/mocker').main;
const save = require('.src/tools/graph_saver/saver').main;
