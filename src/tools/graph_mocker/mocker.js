module.exports = {
    ...
    mock: mock,
    getStringSchema: getStringSchema,
...
const extractApiAndDepends = require('./extract_api_schema').main;
...
/**
 * This function save the complete string schema into a merged_schema.graphql file
 * 
 * @param {Path to save the AST} _path 
 * @param {Complete AST schema} _astObject 
 */
...
function mergeCompleteSchema(_path, _apiPath){
    if (!_path) { 
        console.log("ERROR: No path was provided.");
        printMockerHelp(); 
        return; 
...
function getStringSchema(_path, _apiPath){
    var completeAST = mergeCompleteSchema(_path, _apiPath);
    return graphqllang.print(completeAST);
